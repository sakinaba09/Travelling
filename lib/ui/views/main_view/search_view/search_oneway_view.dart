            ...
            child: Column(
              ...
              Container(
                ...
                Stack(
                       children: [
                         Padding(
                           padding:  EdgeInsetsDirectional.only(start:screenWidth(3),top:screenWidth(15),  ),
                           child: Container(
                         ...
                         Padding(
                           padding:  EdgeInsetsDirectional.only(top: screenWidth(15),end: screenWidth(2.7)),
                           child: CustomButton(text: 'One - Way', textColor: AppColors.backgroundgrayColor, widthPercent: 2.5, heightPercent: 18),
                         ),
                 ...
                 Padding(
                   ...
                   child: Row(
                    ...
                    children: [
                      ...
                      CustomSearchContainer(widthPercent: 2.5, heightPercent: 7, boldtext: 'rutern date', icon:Icons.calendar_month_outlined , text: '', IconColor: AppColors.IconBlueColor,),
                    ],
                   ),
                 ),
                 Padding(
