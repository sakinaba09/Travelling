        ...
        children: [
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            ...
            children: [
              ...
              Icon(Icons.notifications,color: AppColors.TextgrayColor,size: screenWidth(15),),
           ...
           Padding(
             padding:  EdgeInsetsDirectional.only(top: screenWidth(15), bottom: screenWidth(8)),
             child: Row(
          ...
          Padding(
          padding:  EdgeInsetsDirectional.only(top:screenWidth(15),bottom: screenWidth(15) ),
          child:   Row(
          ...
          borderRadius: BorderRadiusDirectional.only(bottomEnd: Radius.circular(20),topEnd: Radius.circular(20)),
          ...
          Padding(
            ...
            padding:  EdgeInsetsDirectional.only(start:screenWidth(2.7) , top: screenWidth(40)),
          
            child: Icon(Icons.favorite,color: AppColors.LightGrayColor,),
          
          ),
          
          Padding(
          
            padding:  EdgeInsetsDirectional.only(top: screenWidth(2.6),start: screenWidth(105)),
            ...
            child: Container(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Text(' HDB Hotel-Financal District \n',style: TextStyle(fontWeight: FontWeight.bold),),
